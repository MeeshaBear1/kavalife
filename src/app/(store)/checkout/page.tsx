            ...
            <fieldset className="rounded-3xl bg-white p-6 shadow-card">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input value={form.phone} onChange={update("phone")} className="field" placeholder="(555) 555-5555" />
                </div>
              </div>
            </fieldset>
            ...
            <div className="rounded-3xl bg-white p-6 shadow-card">
              ...
              <div className="mt-4 border-t border-sand pt-4 text-sm">
                ...
                <p className="mt-2 text-xs text-ink/50">
                  Shipping &amp; tax are calculated and shown before payment.
                </p>
              </div>
              ...
              <p className="mt-3 text-center text-xs text-ink/45">
                Secured by Stripe. You won&apos;t be charged until you confirm.
              </p>
            </div>
          </div>
        </form>
